...
public class TipCommWriteProAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
			...
			try {
				...
				System.out.println("TipCommWriteProAction Exception->"+e.getMessage());
			}
		return "tipboard/tipWirteCommPro.jsp";
	}
