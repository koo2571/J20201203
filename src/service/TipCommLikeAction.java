...
public class TipCommLikeAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			cd.like(bd_num,type_num,comm_num,comm_id,id);
			...
			System.out.println("TipCommLikeAction Exception->"+e.getMessage());
		}
		return "tipboard/tipCommLikePro.jsp";
	}
